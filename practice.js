...
// step :2--open in chrome chrome://inspect/#devices
...
// 1. **Open `launch.json`**:
//    - In VS Code, go to the Debug view by clicking the debug icon in the Activity Bar or pressing `Ctrl+Shift+D`.
//    - Click on the gear icon to open the `launch.json` file.

// 2. **Update `launch.json`**:
//    - Add the `skipFiles` attribute to your configuration to exclude `node_modules` and internal Node.js files. Your configuration should look something like this:
//      ```json
//      {
//        "version": "0.2.0",
//        "configurations": [
...
//            "program": "${workspaceFolder}/app.js" // Replace with the entry point of your application
//          }
//        ]
//      }
//      ```

// 3. click on launch button  by selecting file then go and hit in postman
